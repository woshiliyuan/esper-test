...
public class Client {
    ...
    public static void main(String argv[]) {
    	System.out.println("esper Client start.........");
        int rate = Math.min(DEFAULT_RATE, MINIMUM_RATE);
    ...
    private static void printUsage() {
        System.err.println("com.espertech.esper.example.limit.client.Client <-host hostname> <-port #> <-rate #>");
