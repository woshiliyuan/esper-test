 ...
 * Use -Desper.limit.symbol=1000 to configure the number of symbols to use (hence the number of EPL statements)
 * <p/>
...
public class Symbols {
    ...
    static {
        int symbolcount = Integer.parseInt(System.getProperty("esper.limit.symbol", "1000"));
        LENGTH =String.valueOf(symbolcount).length();
