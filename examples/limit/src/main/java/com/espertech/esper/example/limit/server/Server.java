...
public class Server extends Thread {
    ...
    public static final String CURRENT_DATE = "20140610";
	private int port;
    private int threadCore;
    private int queueMax;
    private int sleepListenerMillis=0;
    private int statSec=0;
    private int simulationRate = 0;
    private int simulationThread =0;
    private String mode;
...
//                cepProvider.registerStatement(stmtString, mode);
                cepProvider.registerStatement(stmtString.replaceAll("[#]requestDate", CURRENT_DATE), mode);
...
//                    cepProvider.registerStatement(stmtString.replaceAll("\\#custId", ticker), mode + "-" + ticker);
                }
    ...
    public static void main(String argv[]) throws IOException {
    	System.out.println("Begin to run Esper demo........");
        // load modes
        ...
        String mode = "LIMITDEMO";//DEFAULT_MODE;
    ...
    private static void printUsage() {
        System.err.println("usage: com.espertech.esper.example.limit.server.Server <-port #> <-thread #> <-queue #> <-sleep #> <-stat #> <-rate #x#> <-mode xyz>");
